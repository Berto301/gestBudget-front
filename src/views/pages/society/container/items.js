    ...
    <tr>
      <th scope="row">
        <Media className="align-items-center">
          <a
            className="avatar rounded-circle mr-3 avatar_society"
          >
            <img
                  alt="..."
                  src={
      ...
      <td className="d-flex">
      <div className="align-items-center d-flex" style={{marginTop:"17px"}}>
      ...
      <td className="text-right">
        <UncontrolledDropdown>
          ...
          <DropdownMenu className="dropdown-menu-arrow" right>
            <DropdownItem href="#pablo" onClick={toggleEditUser}>
              Edit Admin
            </DropdownItem>
