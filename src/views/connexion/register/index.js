...
const Register = () => {
   const [dataUsers,setDataUsers]=useState({
     name:"",firstname:"",phone:"",email:"",password:"",password_check:""
   })
   const [dataGroups,setDataGroups]=useState({name:"",areaActivity:"",phone:"",email:"",adress:""})
   ...
   const onRegister = () =>{
     ...
     const {name,firstname,phone,email,password,password_check} = dataUsers
     const {name:nameGroup,areaActivity,phone:phoneGroup,email:emailGroup,adress} = dataGroups
